...
if [ -z "$RBENCH_BENCHMARKS" ]; then
	RBENCH_BENCHMARKS="fillseq,readwhilewriting,readseq,readmissing,readrandom,readrandomwriterandom"
fi
...
#RBENCH_STATS_INTERVAL_SECONDS=300
RBENCH_STATS_PER_INTERVAL=1
RBENCH_SYNC=0
#RBENCH_THREADS=$(nproc)
RBENCH_VERIFY_CHECKSUM=1

RBENCH_CACHE_SIZE=$((1 * GB))
RBENCH_PIN_L0_FILTER_AND_INDEX_BLOCKS_IN_CACHE=true
RBENCH_CACHE_INDEX_AND_FILTER_BLOCKS=true
RBENCH_MEMTABLE_BLOOM_SIZE_RATIO=0.02
